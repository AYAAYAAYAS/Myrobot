...
def getGesture(isStraight_list):
    if isStraight_list[0]==0 and isStraight_list[1]==0 and isStraight_list[2]==0 and isStraight_list[3]==0 and isStraight_list[4]==0:
	gesture = "0"
    elif isStraight_list[0]==0 and isStraight_list[1]==1 and isStraight_list[2]==0 and isStraight_list[3]==0 and isStraight_list[4]==0:
        gesture = "1"
	...
	gesture = "6"
    elif isStraight_list[0]==1 and isStraight_list[1]==1 and isStraight_list[2]==0 and isStraight_list[3]==0 and isStraight_list[4]==0:
	gesture = "7"
    elif isStraight_list[0]==1 and isStraight_list[1]==1 and isStraight_list[2]==1 and isStraight_list[3]==0 and isStraight_list[4]==0:
        gesture = "8"
    elif isStraight_list[0]==1 and isStraight_list[1]==1 and isStraight_list[2]==1 and isStraight_list[3]==1 and isStraight_list[4]==0:
        gesture = "9"
    else:
        gesture = "None"
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if hand_local:
                    ...
                    gesture_str = h_gesture(angle_list) #hand gesture output # 
                    if gesture_str:
...
def main():
    ...
    #separator_thread.daemon = True  # 设置为后台线程
